...
public class ClientPrometheusMetricsReporterTest {
    ...
    public void testLifeCycle() throws Exception {
        ClientPrometheusMetricsReporter reporter = new ClientPrometheusMetricsReporter(registry, kafkaCollector);
        configs.put(ClientMetricsReporterConfig.ALLOWLIST_CONFIG, "kafka_server_group_name.*");
    ...
    public void testMultipleReporters() throws Exception {
        ClientPrometheusMetricsReporter reporter1 = new ClientPrometheusMetricsReporter(registry, kafkaCollector);
        ...
        ClientPrometheusMetricsReporter reporter2 = new ClientPrometheusMetricsReporter(registry, kafkaCollector);
