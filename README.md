...
```properties
metric.reporters=io.strimzi.kafka.metrics.ClientMetricsReporter
kafka.metrics.reporters=io.strimzi.kafka.metrics.ServerYammerMetricsReporter
...
metric.reporters=io.strimzi.kafka.metrics.ClientMetricsReporter
auto.include.jmx.reporter=false
admin.metric.reporters=io.strimzi.kafka.metrics.ClientMetricsReporter
admin.auto.include.jmx.reporter=false
producer.metric.reporters=io.strimzi.kafka.metrics.ClientMetricsReporter
producer.auto.include.jmx.reporter=false
consumer.metric.reporters=io.strimzi.kafka.metrics.ClientMetricsReporter
